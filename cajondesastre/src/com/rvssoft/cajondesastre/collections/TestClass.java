...
//		ArrayList<Pasajero> listaPasajeros = new ArrayList<Pasajero>(); // se puede mejorar
		...
		List<Pasajero> listaPasajerosList = new ArrayList<Pasajero>(); // se puede mejorar
	...
	private static void testSet() {
		...
		setPasajeros.add(p2);
		setPasajeros.add(p3);
		setPasajeros.add(p4); // Si creo otro objeto igual , lo añade
		// Si creo otro objeto igual , lo añade : NO HACE NADA , NO LO AÑADE
//		setPasajeros.add(new Pasajero(4,"NUEVO", "NUEVA")); 
	 ...
	 * queremos añadir otro tipo de comparación Usar "APARATOS DE DORAIMON"
	 * Usar la interfaces <Compartor<Persona>
	 */
